...
```{r}
summary(explore$age)
ggplot(explore, aes(x=age , fill=gender))+ geom_histogram() + ggtitle("Age Distribution") + xlab("Age")
...
plot(explore.age$participant.age.group, main = "Distribution of participation age group")
...
```
Interestingly, the male psychologist has the staggering matching probability of 0.6. Maybe it's due to their knowledge in psychology to boost their charm. 
