...
explore.match.ratio <- explore  %>% group_by(gender, race_o) %>% summarise(match.prop = mean(match))

ggplot(explore.match.ratio, aes(x = race_o, y = match.prop, fill = gender)) + geom_col(position = "dodge")+ ylab("Matching Probability") + xlab("Race")
...
native.match.ratio <- Native %>% group_by(gender, race_o) %>% summarise(match.prop = mean(match))

ggplot(native.match.ratio, aes(x = race_o, y = match.prop, fill = gender)) + geom_col(position = "dodge")+ ylab("Matching Probability") + xlab("Race")

other.match.ratio <- Other %>% group_by(gender, race_o) %>% summarise(match.prop = mean(match))

ggplot(other.match.ratio, aes(x = race_o, y = match.prop, fill = gender)) + geom_col(position = "dodge")+ ylab("Matching Probability") + xlab("Race")
```
