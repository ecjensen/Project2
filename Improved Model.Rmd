...
```{r}
#decision tree
#lots of dates vs not bad dates 
...
#Cost Model
cost_stacked_model <- C5.0(train$y ~ . + 1, data = model_combined_results, costs = error_cost)

#Cost Prediction
cost_model_prediction = predict(cost_stacked_model, stacked_data, type = "class")

accuracy(cost_model_prediction, test$y, "Stacked Model Accuracy")

#comparing to previous model
confusionMatrix(cost_model_prediction, test$y)
