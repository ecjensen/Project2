...
Our client can adjust this cost matrix when they transition from startup phase into more mature speed dating company. For example, they might want people to have a "good dates", and actually match, on the expense of some actual match got misclassified into not match (False negative). 
```{r}
#This increases total number of matches, flip matrix to be more selective on matches
error_cost_max_match2 <- matrix(c(0, 1, 30, 0), nrow = 2)
